 ...
 * 
 * Original link at
 * https://source.chromium.org/chromium/chromium/src/+/master:components/neterror/resources/offline.js
 * 
 * Chinise annotation by liuyib.
 * view this file at https://github.com/liuyib/game/tree/master/google-dino
 * 
 * The file has secondary changes.
 */
...
(function () {
  ...
  Runner.config = {
    ...
    MOBILE_SPEED_COEFFICIENT: 1.2, //移动设备速度系数
  ...
  Runner.prototype = {
    ...
    onKeyUp: function (e) {
      ...
      if (this.isRunning() && isjumpKey) { // 跳跃
        ...
        // 按下回车键或者等待 750 毫秒后，按下空格键，抑或左键游戏容器，重新开始游戏
  ...
  GameOverPanel.prototype = {
    /**
     * 更新面板尺寸
     * @param {number} width 新画布的宽度
     * @param {number} opt_height 供选择的新画布高度
     */
...
function createRunner(selector) {
  var chromeDino = document.querySelector(selector);
